...
export default {
    ...
    methods: {
        ...
        async insertFootballer() {
            this.visible = false;
            try {
                const response = await axios.post(`http://${ipdata}:${portdata}/forwards`, this.newFootballer);
        ...
        async updateFootballer() {
            ...
            try {
                const response = await axios.put(`http://${ipdata}:${portdata}/forwards/${this.footballer._id}`, {
                    ...this.footballer,
        ...
        async getFootballers() {
            try {
                const response = await axios.get(`http://${ipdata}:${portdata}/forwards`);
        ...
        deleteSelectedFootballers() {
            this.selectedFootballers.forEach(id => {
                axios.delete(`http://${ipdata}:${portdata}/forwards/${id}`)
                .then(() => {
                    this.getFootballers();
                })
                .catch(error => {
